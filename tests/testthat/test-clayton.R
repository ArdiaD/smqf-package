testthat::test_that("baseline value matches closed-form", {
  expect_equal(
...
testthat::test_that("independence limit (theta -> 0) gives density 1", {
  expect_equal(f_clayton_copula_2d_pdf(c(0.3, 0.7), 1e-16), 1, tolerance = 1e-12)
})

testthat::test_that("extreme inputs are finite (no NaN/Inf)", {
