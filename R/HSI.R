...
#' symbol \code{^HSI}), from its first date of availability on Yahoo
#' Finance to 2015-12-31.
#'
#' @format An \code{xts} object with 7214 daily observations and a single
#' column \code{^HSI} containing adjusted close prices in index points.
#' The time index spans from 1986-12-31 to 2015-12-31.
#'
#' @details
#' Originally distributed as \code{HSI} in the \strong{qrmdata} package
